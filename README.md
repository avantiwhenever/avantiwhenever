...
Senior Software Engineer with 9+ years building backend systems, recommendation engines, and search — lately going deep on ML and information retrieval in the age of AI.
...
- 🔭 Currently showcasing my skills in recommendation and search systems — Netflix CLIP-based personalization demo, Lastest recommendation engines, and ML based Search strategies 
- 💞️ Open to collaborating on startups and new career opportunities
...
Senior Software Engineer with an entrepreneurial mindset, focused on customer and developer happiness.

**Experience across E-commerce, Finance, HR, Restaurant Tech, and Search domains:**

- **Possible Finance** — Senior Software Engineer designing loan products across multiple new cities, growing the customer base, and building tooling to improve customer engagement and outreach
- **Wayfair** — Designed first ever semantic vector search for Wayfair's catalog from start to finish to fine relevant product for users. 
...
- **[search](https://github.com/avantiwhenever/search)** — Semantic Search engine, Neural network based Reranker and many more experiments
- **[recommendation-engine](https://github.com/avantiwhenever/recommendation-engine)** — Hexagonal-architecture, gRPC-based recommendation engine over the WANDS catalog, with a GraphQL gateway serving a React UI
- **[netflix-personalization](https://github.com/avantiwhenever/netflix-personalization)** — Demo inspired by Netflix's MAPS artwork-personalization blog post, built with TMDB open data + CLIP embeddings
